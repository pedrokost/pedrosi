...
<body itemscope itemtype="http://data-vocabulary.org/Person">
  <div id="headerArea">
    ...
    <div id="wrapper">
    <h2>Hello. I am a <span itemprop="title">student</span> at <span itemprop="affiliation">University of Ljubljana</span>, <span itemprop="address" itemscope itemtype="http://data-vocabulary.org/Address"><span itemprop="country-name">Slovenia</span></span>. I am studying Computing and Informatics. I am a Flash developer and I unicycle.</h2>
    <nav>
      ...
      <a href="http://blog.pedro.si"><div id="blogBar">Blog<span class="icons blogIcon"></span></div></a>
		...
		<section id="content">
        <h1 class="section"><a href="laboratory.html" title="See more experiments by Pedro Kostelec">Experiment</a></h1>
            <article>
            	<a title="Color clock" href="experiments/color-clock/index.html" target="_self" class="experbutton" rel="prefetch">
                	<div class="experiment">
                  	 	<h4>Colorclock</h4>
                 	 	<div class="tools"><div class="js">Javascript</div></div>
                 	 	<figure class="experFig"><img src="experiments/color-clock/thumbnail.jpg" width="64" height="64" alt="Colorclock"></figure>
                 	 	<time datetime="2010-12-31">25. January 2011</time>
                 	 	<p>Current time converted to a hexadecimal value.</p>
                	</div>
            	</a>
            </article>
        </section>
