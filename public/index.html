...
<body itemscope itemtype="http://data-vocabulary.org/Person">
  <div id="headerArea">
    ...
    <div id="wrapper">
    <h2>Hello, my name is Pedro Kostelec and I'm a <span itemprop="title">programmer, designer and student at the <span itemprop="affiliation">University of Ljubljana</span>, <span itemprop="country-name">Slovenia</span></span>.</h2>
    <nav>
      ...
      <a href="http://blog.pedro.si"><div id="blogBar">Blog<span class="icons blogIcon"></span></div></a>
    	...
    	<section id="contact">
            ...
            <ul>
            	<li id="mail"><a href="mailto:pedrokost+website@gmail.com?subject=Just%20saying%20hi!" title="Send me an email" target="_blank"><span  class="icons mailIcon"></span>E-mail
        ...
        <h1 class="section"><a href="laboratory.html" title="See more experiments by Pedro Kostelec">Labs</a></h1>
            <article>
                 <a title="Books I've read" href="books/login.php" target="_blak" class="experbutton" rel="prefetch">
                    <div class="experiment">
                      <h4>Books I've read</h4>
                      <div class="tools"><div class="html5">HTML5</div><div class="mysql">MySQL</div><div class="php">PHP</div></div>
                      <figure class="experFig"><img src="books/assets/images/thumbnail.png" width="64" height="64" alt="Books I've read"/></figure>
                      <time datetime="2011-4-25">25. April 2011</time>
                      <p>Weekend project: a personal collection of titles of books that I have read.</p>
                    </div>
                </a>
    ...
    <footer>
        <small>copyrigth 2010, Pedro Damian Kostelec, pedro.si</small>
